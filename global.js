...
/*$('input[name*="privileges[1]"]').click(function() {
	$('input[name*="privileges[9]"]').ch
});*/

function clP() {
	if ($('input[name*="privileges[1]"]').is(':checked')) {
	$(this).attr("checked", "true");
	$('input[name*="privileges[9]"]').attr("checked", "true");
	$('input[name*="privileges[21]"]').attr("checked", "true");
	$('input[name*="privileges[6]"]').attr("checked", "true");
	$('input[name*="privileges[22]"]').attr("checked", "true");
	$('input[name*="privileges[23]"]').attr("checked", "true");
	$('input[name*="privileges[27]"]').attr("checked", "true");
} else {
	$(this).removeAttr("checked");
	$('input[name*="privileges[9]"]').removeAttr("checked");
	$('input[name*="privileges[21]"]').removeAttr("checked");
	$('input[name*="privileges[6]"]').removeAttr("checked");
	$('input[name*="privileges[22]"]').removeAttr("checked");
	$('input[name*="privileges[23]"]').removeAttr("checked");
	$('input[name*="privileges[27]"]').removeAttr("checked");
}
}



$('input[name*="privileges[9]"]').click(function () {
	$('input[name*="privileges[1]"]').click();
});

$('input[name*="privileges[21]"]').click(function () {
	$('input[name*="privileges[1]"]').click();
});

$('input[name*="privileges[6]"]').click(function () {
	$('input[name*="privileges[1]"]').click();
});

$('input[name*="privileges[22]"]').click(function () {
	$('input[name*="privileges[1]"]').click();
});

$('input[name*="privileges[23]"]').click(function () {
	$('input[name*="privileges[1]"]').click();
});

$('input[name*="privileges[27]"]').click(function () {
	$('input[name*="privileges[1]"]').click();
});
