<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	*/ 
	...
	/**
	 * User Group Privilege Table
	 * The user group table is used to allocate a group classification to users, typically this is used to group users as either admins or public users.
	 * The grouped users can then be delivered content specific to their group, or restricted access to set areas - i.e. an admin only area.
	 * 
	 * All columns are required.
	*/ 
	$config['database']['user_group_privilege']['table'] = 'user_group_privileges';
	$config['database']['user_group_privilege']['columns']['id'] = 'ugrp_id';
	$config['database']['user_group_privilege']['columns']['name'] = 'ugrp_name';
	$config['database']['user_group_privilege']['columns']['description'] = 'ugrp_desc';
	...
	*/ 
	...
	$config['database']['custom']['user_profile']['custom_columns'] = array(
		'upro_first_name','upro_last_name','upro_phone','upro_newsletter' , 'assigned_ip'
	);
	...
	*/
	$config['security']['login_session_expire'] = 60*60*15;
