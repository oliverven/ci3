...
class Flexi_auth extends Flexi_auth_lite
{
	 ...
	 * @author Rob Hussey
	 */
	public function activate_user($user_id, $activation_token = false, $verify_token = FALSE)
	{
	 ...
	 * @author Rob Hussey
	 */
	public function insert_user($email, $username = FALSE, $password, $user_data, $group_id = FALSE, $activate = TRUE) 
	{
