...
class Demo_auth_admin_model extends CI_Model {
	...
	function update_user_accounts()
    {
		...
		if ($this->flexi_auth->is_privileged('Delete Patrons')) 
		{
	...
	function update_user_account($user_id)
	{
		...
		$validation_rules = array(
			...
			array('field' => 'update_phone_number', 'label' => 'Phone Number', 'rules' => ''),
			array('field' => 'update_newsletter', 'label' => 'Newsletter', 'rules' => ''),
			array('field' => 'update_assigned_ip', 'label' => 'Assigned IP', 'rules' => ''),
			array('field' => 'update_email_address', 'label' => 'Email Address', 'rules' => ''),
