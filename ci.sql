...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2013 at 08:12 PM
...
CREATE TABLE IF NOT EXISTS `demo_user_profiles` (
  ...
  `assigned_ip` varchar(25) NOT NULL DEFAULT '::1',
  PRIMARY KEY (`upro_id`),
...
INSERT INTO `demo_user_profiles` (`upro_id`, `upro_uacc_fk`, `upro_company`, `upro_first_name`, `upro_last_name`, `upro_phone`, `upro_newsletter`, `assigned_ip`) VALUES
(1, 1, '', 'Luminaire', 'Pinsoy', '09272008139', 0, '::1'),
(23, 23, '', 'oliver123', 'quilnet', 'oliver', 0, '192.168.0.106'),
(29, 29, '', 'jarell', 'abao', '1239817', 0, '::1'),
(30, 30, '', 'new', 'new', '', 0, '::1'),
(31, 31, '', 'Awddd', 'Awddd', '', 0, '::1'),
(32, 32, '', 'Trial', 'Trial', '', 0, '::1'),
(36, 36, '', 'Shmoo', 'Shmoo', '', 0, '0'),
(37, 37, '', 'Shmoo', 'Shmoo', '', 0, '::1'),
(38, 38, '', 'Janice', 'Janice', '', 0, '10.8.9.103');

-- --------------------------------------------------------

--
-- Table structure for table `file_directory_link`
--

CREATE TABLE IF NOT EXISTS `file_directory_link` (
  `directory_link_id` int(11) NOT NULL AUTO_INCREMENT,
  `directory_link` varchar(5000) NOT NULL,
  `num_pages` int(11) NOT NULL,
  `processed` tinyint(1) NOT NULL DEFAULT '0',
  `status` varchar(15) NOT NULL,
  `uploaded_by` varchar(500) NOT NULL,
  `uploaded_on` varchar(500) NOT NULL,
  `num_views` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`directory_link_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=200 ;

--
-- Dumping data for table `file_directory_link`
--
...
--
-- Table structure for table `file_ocr_text`
--

CREATE TABLE IF NOT EXISTS `file_ocr_text` (
  `file_ocr_text_id` int(11) NOT NULL AUTO_INCREMENT,
  `directory_link_id` int(11) NOT NULL,
  `page_num` int(11) NOT NULL,
  `ocr_text` text NOT NULL,
  PRIMARY KEY (`file_ocr_text_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3107 ;

--
-- Dumping data for table `file_ocr_text`
--
...
--
-- Table structure for table `marc_block`
--

CREATE TABLE IF NOT EXISTS `marc_block` (
...
--
-- Dumping data for table `marc_block`
--

INSERT INTO `marc_block` (`block_id`, `description`) VALUES
(0, 'Control information, numbers and codes'),
(1, 'Main entry'),
(2, 'Titles and title paragraph (title, edition, imprint)'),
(3, 'Physical descriptions, etc.'),
(4, 'Series statements'),
(5, 'Notes'),
...
--
-- Table structure for table `marc_indicator`
--

CREATE TABLE IF NOT EXISTS `marc_indicator` (
  `marc_tag_id` smallint(6) NOT NULL,
  `indicator_num` tinyint(4) NOT NULL,
  `indicator_subfield` char(1) NOT NULL,
  `description` varchar(80) NOT NULL,
  PRIMARY KEY (`marc_tag_id`,`indicator_num`,`indicator_subfield`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `marc_indicator`
--

INSERT INTO `marc_indicator` (`marc_tag_id`, `indicator_num`, `indicator_subfield`, `description`) VALUES
(10, 1, '#', 'Undefined'),
(10, 2, '#', 'Undefined'),
(13, 1, '#', 'Undefined'),
(13, 2, '#', 'Undefined'),
...
--
-- Table structure for table `marc_subfield`
--

CREATE TABLE IF NOT EXISTS `marc_subfield` (
  `marc_tag_id` smallint(6) NOT NULL,
  `subfield` char(1) NOT NULL,
  `description` varchar(80) NOT NULL,
  `repeatable_flg` char(1) NOT NULL,
  PRIMARY KEY (`marc_tag_id`,`subfield`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `marc_subfield`
--

INSERT INTO `marc_subfield` (`marc_tag_id`, `subfield`, `description`, `repeatable_flg`) VALUES
...
--
-- Table structure for table `marc_tag`
--

CREATE TABLE IF NOT EXISTS `marc_tag` (
  `block_id` tinyint(4) NOT NULL,
  `marc_tag_id` smallint(6) NOT NULL,
  `description` varchar(80) NOT NULL,
  `indicator1_desc` varchar(80) NOT NULL,
  `indicator2_desc` varchar(80) NOT NULL,
  `repeatable_flg` char(1) NOT NULL,
  PRIMARY KEY (`block_id`,`marc_tag_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `marc_tag`
--

INSERT INTO `marc_tag` (`block_id`, `marc_tag_id`, `description`, `indicator1_desc`, `indicator2_desc`, `repeatable_flg`) VALUES
...
INSERT INTO `materials` (`material_id`, `directory_link_id`, `material_type_id`, `pages`, `description`) VALUES
(8, 42, 8, '-', '');

-- --------------------------------------------------------

--
-- Table structure for table `material_marc_tags`
--

CREATE TABLE IF NOT EXISTS `material_marc_tags` (
  `mm_tag_id` int(11) NOT NULL AUTO_INCREMENT,
  `material_type_id` int(11) NOT NULL,
  `marc_tag_id` int(11) NOT NULL,
  `subfield` char(1) NOT NULL,
  `description` varchar(255) NOT NULL,
  PRIMARY KEY (`mm_tag_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=21 ;

--
-- Dumping data for table `material_marc_tags`
--

INSERT INTO `material_marc_tags` (`mm_tag_id`, `material_type_id`, `marc_tag_id`, `subfield`, `description`) VALUES
(6, 6, 100, 'a', 'description'),
(7, 6, 650, 'a', 'description'),
(8, 6, 245, 'a', 'description'),
(9, 8, 100, 'a', 'description'),
(10, 8, 245, 'a', 'description'),
(13, 8, 82, 'a', 'description'),
(14, 8, 650, 'a', 'description'),
(15, 8, 500, 'a', 'description'),
(16, 8, 245, 'c', 'description'),
(17, 8, 250, 'a', 'description'),
(18, 8, 300, 'a', 'description'),
(19, 8, 651, 'a', 'description'),
(20, 8, 650, 'v', 'description');

-- --------------------------------------------------------

--
-- Table structure for table `material_tag_values`
--

CREATE TABLE IF NOT EXISTS `material_tag_values` (
  `material_tag_values_id` int(11) NOT NULL AUTO_INCREMENT,
  `material_id` int(11) NOT NULL,
  `marc_tag_id` int(11) NOT NULL,
  `tag_value` varchar(500) NOT NULL,
  `directory_link_id` int(11) NOT NULL,
  PRIMARY KEY (`material_tag_values_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=10 ;

--
-- Dumping data for table `material_tag_values`
--

INSERT INTO `material_tag_values` (`material_tag_values_id`, `material_id`, `marc_tag_id`, `tag_value`, `directory_link_id`) VALUES
(3, 6, 100, 'Wildman, Edwin', 42),
(4, 6, 245, 'Aguinaldo: A Narrative Filipino Ambition', 42),
(5, 6, 650, 'Philippines', 42),
(6, 7, 82, '992 Ag9w', 42),
(7, 7, 100, 'Wildman, Edwin', 42),
(8, 7, 500, 'Acc,. 37156', 42),
(9, 7, 650, 'Philippines', 42);
...
INSERT INTO `material_types` (`material_type_id`, `material_type`, `description`, `printable`) VALUES
(6, 'Thesis', '', 1),
(8, 'Books', '', 1);
...
(1, 3, 'cho_hakkai801@yahoo.com', 'admin', '$2a$08$sBYgI/Zl.vUqO8u6LQ2EXOD7Ji8LxuLj4n7s7u6vqVRYtqFuMh5qe', '::1', 'XKVT29q2Jr', '', '', '0000-00-00 00:00:00', '', '', 1, 0, 0, '', '0000-00-00 00:00:00', '2013-03-20 08:49:59', '2011-01-01 00:00:00'),
(23, 2, 'oliver', 'oliver123', '$2a$08$yiGZu7iu1jt2CCGT4ZQriO75qAAA9GL4zAcbLXoh9ryywI/mfjeKS', '10.8.11.182', 'd3hw3bq5gf', '81ab7b1e30e738d752c69e86a73f1802d47532a3', '', '0000-00-00 00:00:00', '', '', 1, 0, 0, '', '0000-00-00 00:00:00', '2013-03-19 08:11:24', '2013-03-03 17:48:21'),
(29, 2, 'jazz@yahoo.com', 'jazz', '$2a$08$9arzrV98pXp6M5j6SAlfkueAkiZ97Oj9Ue7M8jOVLuFldTyTcv5s6', '192.168.0.107', 'gddfTjK2DF', '97403162d60b3244744d37b6d2407984882a05f2', '', '0000-00-00 00:00:00', '', '', 1, 0, 0, '', '0000-00-00 00:00:00', '2013-03-09 19:34:54', '2013-03-06 17:36:01'),
(30, 1, 'new', 'neww', '$2a$08$TRtjyUyi2p2QziT/J2UyKunXusnvXTS3GmydXikxzdKsqAQATBQmu', '::1', 'JbbjBZ4Wd8', 'b1c466d61671c2287fb6bf82cabf599bd3eb65b6', '', '0000-00-00 00:00:00', '', '', 1, 0, 0, '', '0000-00-00 00:00:00', '2013-03-13 08:15:50', '2013-03-13 08:15:50'),
(31, 1, '', 'awdd', '$2a$08$UK3zyDlhi7oLSUW/4EeCLeq4FzMb170uqY0Q4IPUxCd0GQ8CwzzGK', '::1', '93PZNtxXhn', '9d03ba9578184143bc31002fca1ea780fb9536d1', '', '0000-00-00 00:00:00', '', '', 1, 0, 0, '', '0000-00-00 00:00:00', '2013-03-13 18:11:18', '2013-03-13 18:11:18'),
(32, 3, '', 'trial', '$2a$08$kXsRJ4yeDruDJRYXunPTVuLuDtOb/zihTiLRG.iXV5BdZxIChi51y', '::1', 'r5sPBT8J2H', 'cdc93df01e09843b78ce51de400f878d4f3cced2', '', '0000-00-00 00:00:00', '', '', 1, 0, 0, '', '0000-00-00 00:00:00', '2013-03-18 20:02:00', '2013-03-14 03:12:33'),
(37, 1, '', 'shmoo', '$2a$08$20ki0QutXWgQyN.ertPfrOt/wL1gYgHuSUprfOFlbZv9tFJBphcsS', '::1', 'kqnvzxjT4d', '8094536777f78d2a8d8a136f2463019781917928', '', '0000-00-00 00:00:00', '', '', 1, 0, 0, '', '0000-00-00 00:00:00', '2013-03-18 20:24:11', '2013-03-18 20:24:11'),
(38, 3, '', 'janice', '$2a$08$zowTxzJTcgktu.vZ48wLPeE0xf3Bo2S3zGgaEfiU3RMuycZKxbUpe', '10.8.9.103', 'HVfHDWmNbb', '7568155bcc2c329963a6b03d0bd4c288bd6dda90', '', '0000-00-00 00:00:00', '', '', 1, 0, 0, '', '0000-00-00 00:00:00', '2013-03-19 08:26:15', '2013-03-19 08:15:25');
...
CREATE TABLE IF NOT EXISTS `user_group_privileges` (
  `ugrp_priv_id` int(11) NOT NULL AUTO_INCREMENT,
  `ugrp_id` int(11) NOT NULL,
  `upriv_id` int(11) NOT NULL,
  PRIMARY KEY (`ugrp_priv_id`)
...
INSERT INTO `user_group_privileges` (`ugrp_priv_id`, `ugrp_id`, `upriv_id`) VALUES
(62, 3, 1),
(63, 3, 2),
(64, 3, 3),
(65, 3, 4),
...
(29, '', '204cac384b89a0fa98586676bf61939456850f17', '2013-03-09 19:34:54'),
(38, '', 'b6cb01f00de0b06ddbf8ca7d6a53876c9e27628a', '2013-03-19 08:37:36');
...
CREATE TABLE IF NOT EXISTS `user_privileges` (
  ...
  `upriv_relation` int(11) NOT NULL,
  `upriv_name` varchar(50) NOT NULL,
...
INSERT INTO `user_privileges` (`upriv_id`, `upriv_relation`, `upriv_name`, `upriv_desc`) VALUES
(1, 0, 'View Patrons', 'User can view user account details.'),
(2, 0, 'View Patron Groups', 'User can view user groups.'),
(3, 0, 'View Privileges', 'User can view privileges.'),
(4, 2, 'Insert Patron Groups', 'User can insert new user groups.'),
(5, 3, 'Insert Privileges', 'User can insert privileges.'),
(6, 1, 'Update Patrons', 'User can update user account details.'),
(7, 2, 'Update Patron Groups', 'User can update user groups.'),
(8, 0, 'Update Privileges', 'User can update user privileges.'),
(9, 1, 'Delete Patrons', 'User can delete user accounts.'),
(10, 2, 'Delete Patron Groups', 'User can delete user groups.'),
(11, 3, 'Delete Privileges', 'User can delete user privileges.'),
(12, 0, 'Admin Dashboard', 'Access of admin dashboard'),
(13, 18, 'Delete Files', 'Delete files, etc.'),
(16, 25, 'Delete Material Type', ''),
(17, 25, 'Insert Material Type', ''),
(18, 0, 'View Files Management Page', ''),
(20, 0, 'View Upload Page', ''),
(21, 1, 'Insert Patron', ''),
(22, 1, 'Search Patron', ''),
(23, 1, 'Change Password of all Patrons', ''),
(24, 2, 'Update Group Privileges', ''),
(25, 0, 'View Material Types Page', ''),
(26, 25, 'Update Material Marc Tags', ''),
(27, 1, 'Update Patron Privileges', ''),
(28, 18, 'Update File Status', ''),
(29, 0, 'Change Own Password', ''),
(30, 25, 'Update Material Type', ''),
(31, 0, 'View File OCR Text', ''),
(32, 0, 'View Materials', ''),
(33, 0, 'Add Material', ''),
(34, 0, 'Delete Material Type Marc', ''),
(36, 0, 'Delete Materials', '');
